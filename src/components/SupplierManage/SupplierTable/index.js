...
import { jiejiType } from '@/services/setting';
...
class SupplierTable extends PureComponent {
    ...
    importSupplier = () => {
        this.props.importSupplier(this.state.selectedRows)
    }

    // 点击下载模板
    handleLoadMuban = () => {
        window.open('/供应商导入导出模版.xlsx');
    }

    render() {

        const { data:{supplierList:{list=[],total}} , showModal , loading} = this.props;
        ...
        const uploadProps = {
            //name: 'file',
            action: jiejiType + '/scm/supplierInfo/resolveFile',
            // headers: {
        ...
        const columns = [{
                ...
                title: '联系人',
                dataIndex: 'buttmanName',
                key: 'buttmanName',
            },{
                title: '联系方式',
                dataIndex: 'buttmanTel',
                key: 'buttmanTel',
            },{
                title: '供应商ID',
        ...
        return (
            <div className={styles.standardTable}>
                <div className={'pb15 pt15'}>
                    ...
                    <Button type="primary" icon="plus" className={'mr15'} onClick={() => this.addSupplier(showModal)}>新建供应商</Button>
                    <Modal
                        title="导入供应商"
                    ...
                    <Button type="primary" className={'mr15'} onClick={this.importSupplier}><Icon type="download" />导出供应商</Button>
